...
- 2025-07-30 16:50 Price/styles.css – убран фон у тега `form` на странице входа.
- 2025-07-30 14:22 Price/login.php, Price/styles.css – минимальная ширина контейнера входа, скруглены поля и кнопка зелёного цвета.
- 2025-07-31 10:00 Price/styles.css – стили контейнера авторизации обновлены, добавлена размытие и тень.
- 2025-07-31 11:00 Price/login.php, Price/styles.css – форма авторизации получила новые стили и id `loginForm`.
