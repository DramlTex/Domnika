...
- 2025-08-26 Price/data.php, Price/js/table.js – отображение товаров без остатка для групп «Ароматизированный чай» и «Приправы».
- 2025-08-26 Price/js/filters.js – фильтр по складу оставляет товары из групп «Ароматизированный чай» и «Приправы» даже при нулевом остатке.
