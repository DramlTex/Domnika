...
Внизу административной панели расположена форма для создания новой учётной записи. Поля логина и пароля растягиваются на всю ширину формы для удобства ввода.
