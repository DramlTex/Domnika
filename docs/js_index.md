...
- 2025-11-17 Price/row_sort_rules.json – установлен порядок сортировки типов через typeOrder.
- 2025-11-18 Price/admin.php – добавлено выпадающее меню для параметра typeSort.

- 2025-07-01 12:33 Price/js/data-loader.js – изменён путь запроса данных на локальный.
...
- 2025-11-25 Price/admin.php, Price/js/rules-loader.js – product_sort_rules.json сохраняет id и имя товара.
